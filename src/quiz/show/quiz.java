...
public class quiz extends JFrame implements ActionListener{
	...
	add(image);
        ...
        lifeline.setBounds(1100,540,150,30);
        ...
        submit.setBounds(1100,620,150,30);
    ...
    public void paint(Graphics g){
        ...
        if (timer>0){
            g.drawString(time, 1050, 400);
        }
        else{
            
            g.drawString("Times up!!", 1050, 400);
        }
